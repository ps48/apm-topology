...
describe('CelestialCard', () => {
    ...
    const mockSetUnstackedAggregateNodeIds = vi.fn();
    const mockSetActiveMenuNodeId = vi.fn();
    ...
    it('applies correct styling when alarming', () => {
        ...
        expect(card).toHaveClass('border-status-breached');
        expect(card).toHaveClass('bg-container-breached');
    });
