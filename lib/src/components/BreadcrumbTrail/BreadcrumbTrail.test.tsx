...
describe('BreadcrumbTrail', () => {
    ...
    it('renders all breadcrumbs', () => {
        render(<BreadcrumbTrail breadcrumbs={mockBreadcrumbs} onBreadcrumbClick={mockOnBreadcrumbClick} />);
    ...
    it('handles breadcrumbs without node property', () => {
        ...
        render(<BreadcrumbTrail breadcrumbs={breadcrumbsWithoutNode} onBreadcrumbClick={mockOnBreadcrumbClick} />);
    ...
    it('renders hotspot when provided', () => {
        const hotspot = <div data-testid="tutorial-hotspot">Tutorial Hotspot</div>;
