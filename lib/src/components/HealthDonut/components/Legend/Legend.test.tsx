...
describe('Legend', () => {
    ...
    it('uses left triangle position by default', () => {
        ...
        expect(legendElement.className).toContain('triangle-left');
        expect(legendElement.className).not.toContain('triangle-right');
    });
    ...
    it('applies right triangle position when specified', () => {
        ...
        const legendElement = container.firstChild as HTMLElement;
        expect(legendElement.className).toContain('triangle-right');
        expect(legendElement.className).not.toContain('triangle-left');
    });
