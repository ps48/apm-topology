...
describe('HealthDonut', () => {
    ...
    test('renders breached SliStatus icon when health status is "breached"', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<Ec2Icon />} health={breachedHealth} />);
    ...
    test('renders recovered SliStatus icon when health status is "recovered"', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<Ec2Icon />} health={recoveredHealth} />);
    ...
    test('does not render SliStatus icon when "sli" is not provided', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<Ec2Icon />} />);
