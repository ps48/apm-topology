...
export const CelestialNodeActionsProvider: React.FC<PropsWithChildren<CelestialNodeActionsProviderProps>> = ({
    onDataFetch,
    addBreadcrumb,
    onDashboardClick,
    children,
    ...
    const { selectedNodeId, setSelectedNodeId, unstackedAggregateNodeIds, setUnstackedAggregateNodeIds } =
    ...
    const onUnstackNode = useCallback(
        (event: React.MouseEvent, props: CelestialCardProps) => {
            ...
            setUnstackedAggregateNodeIds([...unstackedAggregateNodeIds, props.aggregatedNodeId as string]);
