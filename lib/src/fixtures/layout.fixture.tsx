...
const updateAlarmStates = (map: NodeMap): NodeMap => {
    ...
    Object.entries(map).forEach(([groupId, group]) => {
        const hasAlarmingNodes = group.nodes.some(
            (node) => node.data?.health?.status && ['recovered', 'breached'].includes(node.data.health?.status),
        );
...
const topLevelNodes: Node<CelestialCardProps>[] = [
    {
        id: 'group-frontend',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
const frontendNodes: Node<CelestialCardProps>[] = [
    {
        id: 'web-app',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
// API Layer Contents
const apiNodes: Node<CelestialCardProps>[] = [
    {
        id: 'api-gateway',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
const computeNodes: Node<CelestialCardProps>[] = [
    {
...
const microservicesNodes: Node<CelestialCardProps>[] = [
    {
        id: 'user-service',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
const dataNodes: Node<CelestialCardProps>[] = [
    {
...
const databasesNodes: Node<CelestialCardProps>[] = [
    {
        id: 'relational-db',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
const analyticsNodes: Node<CelestialCardProps>[] = [
    {
        id: 'data-lake',
        type: 'celestialNode',
        position: { x: 0, y: 0 },
...
// Canary Nodes Array
const canaryNodes: Node<CelestialCardProps>[] = Array.from({ length: 10 }, (_, index) => ({
    id: `canary-${index + 1}`,
    type: 'celestialNode',
    position: {
        x: 0,
...
const stackedNodes: Node<CelestialCardProps>[] = [
    ...canaryNodes,
